...
num_tokens_box = st.number_input( "Number of tokens to generate: " , min_value=10 , max_value=100 , value=50 , step=10 )
...
if st.button( "Predict" ):
    ...
    output = predictor.predict_tokens( get_tokens( input_prompt ) , num_tokens_box , temperature )
